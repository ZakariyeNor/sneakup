...
def test_product_detail_url_resolves():
    assert resolve(
            f'{PRODUCTS_PREFIX}/product_detail/1/'
            ).func == views.product_detail
...
def test_edit_product_url_resolves():
    assert resolve(
        f'{PRODUCTS_PREFIX}/edit_product/1/').func == views.edit_product


@pytest.mark.django_db
def test_delete_product_url_resolves():
    assert resolve(
        f'{PRODUCTS_PREFIX}/delete_product/1/').func == views.delete_product
